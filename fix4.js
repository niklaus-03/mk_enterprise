const fs = require('fs');
let lines = fs.readFileSync('frontend/src/pages/AdminDashboard.js', 'utf8').split('\n');
...
// 0-indexed: lines 3949 to 3961 inclusive are replaced.
const before = lines.slice(0, 3949); // up to 3948 (0 to 3948)
const after = lines.slice(3962); // from 3962 to end

const newContent = before.join('\n') + '\n' + replacement + '\n' + after.join('\n');
fs.writeFileSync('frontend/src/pages/AdminDashboard.js', newContent);
console.log('Fixed AdminDashboard by line numbers');
