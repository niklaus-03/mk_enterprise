const fs = require('fs');
let lines = fs.readFileSync('frontend/src/pages/ManagerDashboard.js', 'utf8').split('\n');
...
// Line 3609 is <div className="modal-body">
// Line 3626 is <div className="form-group"> Amount Received...
// So we replace 3610 to 3624 inclusive.
// 0-indexed: lines 3609 to 3624 inclusive are replaced.
const before = lines.slice(0, 3609); // up to 3608
const after = lines.slice(3625); // from 3625 to end

const newContent = before.join('\n') + '\n' + replacement + '\n' + after.join('\n');
fs.writeFileSync('frontend/src/pages/ManagerDashboard.js', newContent);
console.log('Fixed ManagerDashboard by line numbers');
