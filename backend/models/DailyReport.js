...
const dailyReportSchema = new mongoose.Schema({
  ...
  walkin_trip_summary: {
    initial_load: [{ product_name: String, quantity: Number, value: Number }],
    sold_items: [{ product_name: String, quantity: Number, value: Number }],
    remaining_items: [{ product_name: String, quantity: Number, value: Number }]
  },
...
dailyReportSchema.index({ manager_id: 1, date: 1 });
