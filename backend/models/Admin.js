...
const adminSchema = new mongoose.Schema({
  ...
  role: {
    type: String,
    enum: ['supervisor', 'manager', 'driver', 'temp_manager', 'walkin_manager'],
    default: 'supervisor',
  },
  ...
  // New field for temporary manager
  assigned_managers: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Admin' }],
  
  // New fields for walkin_manager
  active_vehicle_number: { type: String, default: '' },
  active_driver_name: { type: String, default: '' },
  active_destination: { type: String, default: '' },
  new_trip_approved: { type: Boolean, default: false }, // For multiple trips in a day
  is_trip_active: { type: Boolean, default: false },
