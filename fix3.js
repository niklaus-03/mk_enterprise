...
function fix(file) {
  ...
  if (startIdx > -1 && endIdx > -1 && endIdx > startIdx) {
     ...
     content = before + '<div className="modal-body">\n              ' + replacement + '\n\n' + after;
     fs.writeFileSync(file, content);
     console.log('Fixed via index splitting in', file);
  } else {
     console.log('Could not find markers in', file);
  }
}

fix('frontend/src/pages/AdminDashboard.js');
fix('frontend/src/pages/ManagerDashboard.js');
