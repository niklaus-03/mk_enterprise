...
export const customerApi = {
  ...
  getAddresses: () => api.get('/customers/addresses').then(res => Array.isArray(res) ? res : []),
...
export const walkinApi = {
  getActiveTrip: () => api.get('/walkin/active-trip'),
  allActiveTrips: () => api.get('/walkin/all-active-trips'),
  assignVehicle: (data) => api.post('/walkin/assign-vehicle', data),
  updateVehicle: (data) => api.put('/walkin/update-vehicle', data),
  startTrip: () => api.post('/walkin/start-trip'),
  requestNextTrip: (data) => api.post('/walkin/request-next-trip', data),
  approveNextTrip: (requestId) => api.post(`/walkin/approve-next-trip/${requestId}`),
  rejectRequest: (requestId) => api.post(`/walkin/reject-request/${requestId}`),
  getAllRequests: () => api.get('/walkin/requests'),
  markComplete: () => api.post('/walkin/mark-complete'),
  getAllTrips: () => api.get('/walkin/all-trips'),
